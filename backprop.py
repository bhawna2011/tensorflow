...
#computational graph for forward pass,error ,gradient and update
...
with tf.Session() as sess:
    ...
    for epoch in range (max_epochs):
        ...
        sess.run(step,feed_dict={x_in:mnist.test.images,y:mnist.test.labels})
        if epoch%1000==0:
            ...
            print(f'epoch: {epoch} acctest: {acc_test/100} acc train : {acc_train/600}')